REVOKE EXECUTE ON FUNCTION public.upsert_discord_presence(text, text, text, text, text[]) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.list_online_discord_users(timestamptz) FROM PUBLIC;
