...
function SuiviDemandesPage() {
  ...
  if (!canManageContactRequests(user as DiscordSessionUser)) {
    return (
      <Shell>
        <div style={{ ...card, borderColor: "rgba(248,113,113,0.4)", background: "rgba(127,29,29,0.18)", textAlign: "center", padding: "38px 22px" }}>
        ...
        {open && (
          <div style={{ marginTop: 16, display: "grid", gap: 16 }}>
            <div style={{ border: "1px solid rgba(34,197,94,0.22)", borderRadius: 14, padding: 14, background: "rgba(34,197,94,0.04)" }}>
              <div style={{ color: "#4ade80", fontSize: 11, fontWeight: 700, marginBottom: 10, textTransform: "uppercase", letterSpacing: 1 }}>
            ...
            {(internalMessages.length > 0 || (row.notes?.length ?? 0) > 0) && (
              <div style={{ border: "1px solid rgba(245,158,11,0.24)", borderRadius: 14, padding: 14, background: "rgba(245,158,11,0.04)" }}>
                <div style={{ color: "#fbbf24", fontSize: 11, fontWeight: 700, marginBottom: 10, textTransform: "uppercase", letterSpacing: 1 }}>
