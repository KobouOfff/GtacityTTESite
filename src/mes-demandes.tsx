  ...
  return (
    <Shell>
      <section style={hero}>
        ...
        <div style={{ position: "relative", display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 16 }}>
          <div>
            ...
            <p style={{ ...muted, margin: 0, maxWidth: 520, lineHeight: 1.65 }}>
              Bonjour <b style={{ color: "var(--tte-fg-strong)" }}>{user.username}</b>, retrouve ici le suivi complet de tes échanges
        ...
        {rows.length > 0 && (
          <div style={statRow}>
            <Stat label="Demandes" value={rows.length} color="var(--tte-fg-strong)" icon="🗂" />
      ...
      <div style={{ padding: "16px 18px" }}>
        ...
        >
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 11, color: "var(--tte-subtle)", fontFamily: "ui-monospace, monospace", letterSpacing: 0.6 }}>
              {row.ref}
            </div>
        ...
        {row.assigned_branch && (
          <div style={{ marginTop: 12, ...muted, fontSize: 13 }}>
            Service chargé du dossier : <b style={{ color: "var(--tte-fg-strong)" }}>{getBranchLabel(row.assigned_branch)}</b>
          </div>
        )}

        {open && (
          <>
            <div style={{ marginTop: 14, borderTop: "1px solid var(--tte-border)", paddingTop: 14 }}>
...
const chipActive: React.CSSProperties = {
  ...
  color: "var(--tte-chip-active-text)",
};
...
const closedNote: React.CSSProperties = {
  ...
  border: "1px dashed var(--tte-border-strong)",
  borderRadius: 10,
  padding: "10px 12px",
};
